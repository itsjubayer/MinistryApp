...
namespace FlatManagement.Controllers
{
    ...
    public class AdministrationController : Controller
    {
        ...
        public AdministrationController(RoleManager<IdentityRole> roleManager,
                                        UserManager<ApplicationUser> userManager, MinistryDBContext context)
        {
        ...
        public IActionResult ListUsers()
        {
            ...
            var users = userManager.Users.Where(u=>u.IsActive== true);
            return View(users);
        }
        ...
        public async Task<IActionResult> EditUser(EditUserViewModel model)
        {
            ...
            else
            {
                ...
                //user.DOB = user.DOB,
                //user.ETIN = model.ETIN;
                user.PassportNo = model.PassportNo;
                user.pre_Address = model.pre_Address;
                user.NID = model.NID;
        ...
        public async Task<IActionResult> DeleteRole(string id)
        {
            ...
            {
                var usersOfRole = await userManager.GetUsersInRoleAsync(role.Name);
                ...
                {
                    ViewBag.ErrorMessage = $"Please remove the role from user then try to delete.";
                    return View("NotFound");
                }
    ...
    ManageUserRoles(List<UserRolesViewModel> model, string userId)
        ...
        [Route("Administrator/nibash")]
        [HttpGet]
        //[Authorize]
        public IActionResult InstallNibash()
        {
            return View();
        }
